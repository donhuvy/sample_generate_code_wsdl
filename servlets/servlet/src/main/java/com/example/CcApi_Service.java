 ...
 * 
 */
@WebServiceClient(name = "CcApi", targetNamespace = "http://impl.bulkSms.ws/", wsdlLocation = "http://apismsbrand.viettel.vn:8998/bulkapi?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://apismsbrand.viettel.vn:8998/bulkapi?wsdl");
